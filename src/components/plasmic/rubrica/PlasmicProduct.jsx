...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: _8f2R2hBko4xI0/css
import neckties2103471920JpgFZfu9JbEop6Rxf from "./images/neckties2103471920Jpg.jpg"; // plasmic-import: fZfu9JbEOP6RXF/picture
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__npqet)}
            displayHeight={"auto"}
            ...
            loading={"lazy"}
            src={{
              src: neckties2103471920JpgFZfu9JbEop6Rxf,
              fullWidth: 1920,
              fullHeight: 1280,
